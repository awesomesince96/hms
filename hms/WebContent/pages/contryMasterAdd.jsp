...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-10">
                    <div id="pageLabelAdd"> <h1 class="">Contry Master Add</h1></div>
                    <div id="pageLabelEdit"><h1 class="">Contry Master Edit</h1></div> 
                </div>
...
<script>
    ...
    function initialiseVariables(){
		editMode = false;
    	 contryId = '<%= request.getParameter("id")%>';
    	if(contryId === 'null'){
    		$('#pageLabelAdd').show();
    		$('#pageLabelEdit').hide();
    	...
    	$.ajax({
    		...
    		success: function(response) {
    			...
    			setTimeout(
    					  function() 
    					  {
    			window.location.href = "./contryMasterList.jsp"
    					  }, 1000);
    		},
    		error: function(response) {
    			$.toast({
